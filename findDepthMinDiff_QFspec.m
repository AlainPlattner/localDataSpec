function rs=findDepthMinDiff_QFspec(spec,lrng,robs,rstart,Ltap,Lmax)
% rs=findDepthMinDiff_QFspec(spec,lrng,robs,rstart,Ltap,Lmax)
%
...
rs = fminsearch(@(x) mindiff_QFspec(spec,x,lrng,Ltap,robs,Lmax), rstart, opts);
