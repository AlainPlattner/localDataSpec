function err=mindiff_McLeod(spec,rcore,lrng,Ltap,robs,rplanet,Lmax,bias)
% err=mindiff_McLeod(spec,rcore,lrng,Ltap,robs,Lmax,bias)
%
...
Smc_reg=McLeod(rcore,robs,rplanet,Lmax,Ltap,bias);
