function varargout=localspectrumDataVarAlt(data,lon,lat,rad,rplanet,rsat,Lmax,Ltap,dom,Jcof,Jtap,rotcoord,Nspec,optn)
% [spec,specvar,spectap]=localspectrumDataVarAlt(data,lon,lat,rad,rplanet,rsat,Lmax,Ltap,dom,Jcof,Jtap,rotcoord,Nspec,optn)
%
